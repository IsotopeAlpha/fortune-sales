      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-6 flex items-center justify-between">
          ...
          >
            <span className="flex h-9 w-9 items-center justify-center rounded-full bg-slate-900 text-sky-300 shadow-inner">
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M12.79 16.29a1 1 0 0 1-1.42 1.42l-6-6a1 1 0 0 1 0-1.42l6-6a1 1 0 1 1 1.42 1.42L8.41 10l4.38 4.29z"
                  clipRule="evenodd"
                />
              </svg>
            </span>
          ...
          <div className="text-sm text-slate-400">
            Product ID:{" "}
            <span className="font-medium text-slate-100">{product?.id}</span>
          </div>
        </div>
              ...
              <div className="flex flex-col gap-6 lg:flex-row lg:items-start">
                ...
                <div className="flex flex-1 flex-col justify-between">
                  <div>
                    ...
                    <p className="mt-2 text-sm uppercase tracking-wider text-sky-400">
                      {product?.category}
                    </p>

                    <div className="mt-4 flex items-center gap-4">
                      <div className="flex items-center gap-2">
                        <span className="rounded-md bg-amber-600/20 px-2 py-1 text-sm font-semibold text-amber-300">
                          {product?.rating}★
                        </span>
          ...
          <aside className="space-y-6">
            <div className="rounded-2xl bg-slate-800 p-6 shadow-md ring-1 ring-slate-700">
              ...
              <Link to="/checkout">
                <button
                  onClick={addToCart}
                  className="rounded-xl border border-transparent bg-gradient-to-r from-sky-500 via-cyan-500 to-teal-400 px-4 py-2 text-sm font-semibold text-slate-950 shadow-lg shadow-cyan-500/20 transition duration-200 hover:scale-[1.01] hover:drop-shadow-xl"
                >
                  Buy now
                </button>
              </Link>
